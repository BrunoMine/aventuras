--[[
	...
	Framework : Tarefa do tipo npc_placenode
...
aventuras.tarefas.npc_placenode = {}

local S = aventuras.S


-- Gerar um formspec de tarefa
aventuras.tarefas.npc_placenode.gerar_form = function(aventura, dados, npc, name)
...
aventuras.tarefas.npc_placenode.adicionar = function(aventura, def)
...
aventuras.tarefas.npc_placenode.npcs = {}

-- Receber chamada de 'on_rightclick' de algum dos npcs acessados
aventuras.tarefas.npc_placenode.npcs.on_rightclick = aventuras.comum.get_on_rightclick_npc("npc_placenode")
...
minetest.register_on_joinplayer(function(player)
	...
	if aventuras.bd.verif("player_"..name, "tarefa_npc_placenode") == true then
		if not aventuras.online[name].npc_placenode then aventuras.online[name].npc_placenode = {} end
		aventuras.online[name].npc_placenode.aven = aventuras.bd.pegar("player_"..name, "tarefa_npc_placenode")
	end
end)
